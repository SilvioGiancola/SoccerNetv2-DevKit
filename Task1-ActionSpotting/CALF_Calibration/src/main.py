...
if __name__ == '__main__':
    ...
    parser.add_argument('--calibration_physic',  required=False, action='store_true',  help='One channel per information and no color'  )
    ...
    parser.add_argument('--with_resnet', required=False, type=int,   default=0,     help='use resnet number x' )
    parser.add_argument('--with_dense',  required=False, action='store_true',     help='use dense layer' )
    parser.add_argument('--with_trail', required=False, type=int,   default=0,     help='use trail on radar view' )
    parser.add_argument('--with_dropout', required=False, type=float,   default=0.0,     help='use dropout between the features' )
