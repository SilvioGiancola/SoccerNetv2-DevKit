...
#         Weight_camera_type= torch.tensor([0.00143, 0.0003865, 0.0174, 0.0196, 0.128, 0.00171, 0.0552, 0.00239, 0.02, 0.00765,0.1001, 0.0101,0.594,0.0253], dtype=torch.float).cuda()
        Weight_camera_type= torch.tensor([0.00059148, 0.0011937, 0.0257837, 0.02792131, 0.29968935, 0.02532632, 0.09931299, 0.00722039, 0.04672078, 0.01889945,0.24348754, 0.03107723,0,0], dtype=torch.float).cuda()
